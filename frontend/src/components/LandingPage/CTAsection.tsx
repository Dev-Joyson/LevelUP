        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              <a className="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-center" href="/internship">Apply an Internship</a>
                <a className="bg-background-light dark:bg-card-dark text-text-light dark:text-text-dark px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-opacity-80 transition-colors border border-primary text-center" href="/join">Post an Internship</a>
            </div>
          </div>
        </div>
      </div>
