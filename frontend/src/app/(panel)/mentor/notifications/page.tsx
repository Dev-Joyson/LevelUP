...
import { Bell, Check, Clock, BookOpen, User, Calendar } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Mentor Notifications</h1>
          <p className="text-gray-600 mt-2">
            Stay updated with session bookings and important updates
          </p>
        </div>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="space-x-2">
              ...
              <Button
                variant={typeFilter === 'session_booked' ? 'default' : 'outline'}
                size="sm"
                onClick={() => setTypeFilter('session_booked')}
              >
                Session Bookings
              </Button>
              <Button
